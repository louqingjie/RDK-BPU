...
- **完整量化可行性评估（图结构/算子/动态范围实测）：[RDK_X5_量化可行性评估_AT_NN_Detector.md](./RDK_X5_量化可行性评估_AT_NN_Detector.md)**
- **上科大/同济传统精修与 PnP 解算解读：[传统精修与PnP解算分析_上科大与同济方案.md](./传统精修与PnP解算分析_上科大与同济方案.md)**
